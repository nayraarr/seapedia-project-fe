    ...
    return (
        <MainLayout>
            ...
            <section className="text-center py-20 px-4">
                ...
                <h1 className="text-5xl font-extrabold text-slate-800 mb-4 leading-tight tracking-tight">
                ...
                <div className="flex items-center justify-center gap-4">
                    <Link
                        to="/products"
                        className="bg-blue-600 text-white px-8 py-3.5 rounded-xl text-base font-semibold hover:bg-blue-700 transition shadow-sm shadow-blue-200"
                    >
                        Jelajahi Produk
                    </Link>
                    <Link
                        to="/register"
                        className="border border-blue-200 text-blue-600 px-8 py-3.5 rounded-xl text-base font-semibold hover:bg-blue-50 transition"
                    >
                        Daftar Gratis
                    </Link>
                </div>
            ...
            <section className="grid grid-cols-3 gap-4 mb-16">
                {[
                    ...
                    <div key={stat.label} className="bg-white border border-blue-100 rounded-2xl p-6 text-center">
