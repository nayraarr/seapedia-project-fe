...
export default function RegisterPage() {
    ...
    const [form, setForm] = useState({ fullName: '', username: '', email: '', password: '', confirmPassword: '', roles: [] })
    ...
    const validate = () => {
        const errors = {}
        if (!form.fullName.trim()) errors.fullName = 'Nama lengkap tidak boleh kosong'
        ...
        if (!form.confirmPassword.trim()) errors.confirmPassword = 'Konfirmasi password tidak boleh kosong'
        else if (form.password !== form.confirmPassword) errors.confirmPassword = 'Password tidak cocok'
                ...
                <div className="bg-white rounded-2xl border border-ocean-100 shadow-card p-6 sm:p-8 animate-slide-up">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                        ...
                        <Input
                            ...
                            rightElement={(
                                <button type="button" onClick={() => setShowConfirmPassword(p => !p)} className="text-slate-400 hover:text-ocean-500 transition cursor-pointer">
                                    {showConfirmPassword ? (
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" />
                                        </svg>
