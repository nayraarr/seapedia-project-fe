        ...
        <MainLayout>
            ...
            {loading ? (
                ...
                <div className="space-y-6">
                    <div className="grid md:grid-cols-3 gap-4">
                        <SummaryCard label="Total Belanja" value={formatRupiah(report.totalSpent)} accent="text-blue-700" />
                    ...
                    <div className="bg-white border border-blue-100 rounded-2xl p-5">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {report.statusBreakdown.map(s => (
                                <span key={s.status} className="text-xs font-semibold px-3 py-1.5 rounded-full bg-blue-50 text-blue-700">
                            ...
                            <div className="space-y-3">
                                {report.recentOrders.map(order => (
                                    <Link
                                        ...
                                        className="block border border-slate-200 rounded-xl p-4 hover:border-blue-300 transition"
                                    >
                                        <div className="flex justify-between items-center gap-3">
                                            ...
                                            <p className="font-bold text-blue-700">{formatRupiah(order.totalAmount)}</p>
                                        </div>
                                    </Link>
                                ))}
                            </div>
