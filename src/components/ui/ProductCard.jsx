...
export default function ProductCard({ product }) {
    ...
    return (
        <div className="bg-white rounded-2xl border border-blue-100 p-4 hover:shadow-md hover:border-blue-300 transition-all duration-200">
